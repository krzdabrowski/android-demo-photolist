...
class PhotoAdapter(private val context: Context, private val items: List<Photo>, private val listener: ItemListener) : RecyclerView.Adapter<PhotoAdapter.PhotoViewHolder>() {
